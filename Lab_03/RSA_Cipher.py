...
class MyApp(QMainWindow):
    def __init__(self):
        ...
        self.ui.pushButton_7.clicked.connect(self.call_api_sign)
    ...
    def call_api_sign(self):
        ...
        try:
            ...
            if response.status_code == 200:
                data = response.json()
                self.ui.textEdit_2.setText(data["signature"].strip())
                msg = QMessageBox()
                msg.setIcon(QMessageBox.Information)
    ...
    def call_api_verify(self):
        ...
        signature = self.ui.textEdit_2.toPlainText().strip().replace('\n', '').replace('\r', '')
        payload = {
            "message": self.ui.textEdit_3.toPlainText(),
            "signature": signature
        }
